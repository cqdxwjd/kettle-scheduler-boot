...
CREATE TABLE `k_category`  (
  ...
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
  `del_flag` int(11) DEFAULT NULL COMMENT '是否删除（0：存在；1：删除）',
...
-- ----------------------------
INSERT INTO `k_category` VALUES (2, 'task_test', '2020-12-02 16:08:01', NULL, '2020-12-02 16:08:01', NULL, 0);
...
CREATE TABLE `k_job`  (
  ...
  `category_id` int(11) DEFAULT NULL COMMENT '分类ID（外键ID）',
  `job_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '作业名称',
  `job_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '任务描述',
  `job_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '执行类型（rep：资源库；file：文件）',
  `job_path` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '作业保存路径（可以是资源库中的路径也可以是服务器中保存作业文件的路径）',
  `job_repository_id` int(11) DEFAULT NULL COMMENT '作业的资源库ID',
  `job_quartz` int(11) DEFAULT 1 COMMENT '定时策略（外键ID）',
  `sync_strategy` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '同步策略(T+n)',
  `job_log_level` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '日志级别(Basic，Detailed，Error，Debug，Minimal，Rowlevel）',
  ...
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
  `del_flag` int(11) DEFAULT NULL COMMENT '是否删除（0：存在；1：删除）',
  `ftp_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '由于资源库ID只能使用int类型，故增加一个ftp关联id',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `k_job_monitor`  (
  ...
  `monitor_job_id` int(11) DEFAULT NULL COMMENT '监控的作业ID',
  ...
  `run_status` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '运行状态（起始时间-结束时间,起始时间-结束时间……）',
  `last_execute_time` datetime(0) DEFAULT NULL COMMENT '上一次执行时间',
  `next_execute_time` datetime(0) DEFAULT NULL COMMENT '下一次执行时间',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
...
CREATE TABLE `k_job_record`  (
  ...
  `record_job_id` int(11) DEFAULT NULL COMMENT '作业ID',
  `start_time` datetime(0) DEFAULT NULL COMMENT '启动时间',
  `stop_time` datetime(0) DEFAULT NULL COMMENT '停止时间',
  `record_status` int(11) DEFAULT NULL COMMENT '任务执行结果（1：成功；0：失败）',
  `log_file_path` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '作业日志记录文件保存位置',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
...
CREATE TABLE `k_log`  (
  ...
  `admdivcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '区划',
  `type` int(11) DEFAULT NULL COMMENT '步骤类型  1为读  2为写  3为其他',
  `transname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换名',
  `stepname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '步骤名',
  `i` int(11) DEFAULT NULL COMMENT '当前步骤生成的记录数（从表输出、文件读入）',
  `o` int(11) DEFAULT NULL COMMENT '当前步骤输出的记录数（输出的文件和表）',
  `r` int(11) DEFAULT NULL COMMENT '当前步骤更新过的记录数',
  `w` int(11) DEFAULT NULL COMMENT '当前步骤更新过的记录数',
  `u` int(11) DEFAULT NULL COMMENT '当前步骤更新过的记录数',
  `e` int(11) DEFAULT NULL COMMENT '当前步骤处理的记录数',
  `time` datetime(0) DEFAULT NULL COMMENT '完成时间',
...
CREATE TABLE `k_quartz`  (
  ...
  `quartz_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '任务描述',
  `quartz_cron` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '定时策略',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
...
CREATE TABLE `k_repository`  (
  ...
  `rep_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库名称',
  `rep_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库类型: fileRep-文件, dbRep-数据库',
  `rep_username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录用户名',
  `rep_password` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录密码',
  `rep_base_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件资源库路径: rep_type=fileRep生效',
  `db_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库数据库类型（MYSQL、ORACLE）',
  `db_access` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库数据库访问模式（\"Native\", \"ODBC\", \"OCI\", \"Plugin\", \"JNDI\")',
  `db_host` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库数据库主机名或者IP地址',
  `db_port` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库数据库端口号',
  `db_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源库数据库名称',
  `db_username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数据库登录账号',
  `db_password` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数据库登录密码',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源库表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of k_repository
-- ----------------------------
INSERT INTO `k_repository` VALUES (1, 'test', 'dbRep', 'admin', 'admin', '/test', 'MYSQL', 'Native', '139.199.31.200', '3506', 'kettle_scheduler_z', 'sample', 'sample', '2020-12-02 15:37:23', NULL, '2020-12-02 15:37:23', NULL, 0);
...
CREATE TABLE `k_trans`  (
  ...
  `category_id` int(11) DEFAULT NULL COMMENT '分类ID',
  `trans_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换名称',
  `trans_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换描述',
  `trans_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '执行类型（rep：资源库；file：文件）',
  `trans_path` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换保存路径（可以是资源库中的路径也可以是服务器中保存作业文件的路径）',
  `trans_repository_id` int(11) DEFAULT NULL COMMENT '转换的资源库ID',
  `trans_quartz` int(11) DEFAULT 1 COMMENT '定时策略（外键ID）',
  `sync_strategy` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '同步策略(T+n)',
  `trans_log_level` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '日志级别(Basic，Detailed，Error，Debug，Minimal，Rowlevel）',
  ...
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
  `del_flag` int(11) DEFAULT NULL COMMENT '是否删除（0：存在；1：删除）',
  `trans_params` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换中使用到的参数信息，JSON格式',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `trans_name_unique_index`(`trans_name`) USING BTREE COMMENT '转换名称唯一索引'
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '转换表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of k_trans
-- ----------------------------
INSERT INTO `k_trans` VALUES (3, 2, 't_增量', '', 'file', 'D:/apps/var/kettle-script-file/T_增量.ktr', NULL, 1, '', 'Error', 1, '2020-12-02 16:56:19', NULL, '2020-12-02 17:27:42', NULL, 0, '{}');
...
CREATE TABLE `k_trans_monitor`  (
  ...
  `monitor_trans_id` int(11) DEFAULT NULL COMMENT '监控的转换的ID',
  `monitor_success` int(11) DEFAULT NULL COMMENT '成功次数',
  `monitor_fail` int(11) DEFAULT NULL COMMENT '失败次数',
  `monitor_status` int(11) DEFAULT NULL COMMENT '监控状态（是否启动，1:启动；2:停止）',
  `run_status` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '运行状态（起始时间-结束时间,起始时间-结束时间……）',
  ...
  `del_flag` int(11) DEFAULT NULL COMMENT '是否删除（0：存在；1：删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '转换监控表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of k_trans_monitor
-- ----------------------------
INSERT INTO `k_trans_monitor` VALUES (3, 3, 8, 0, 1, '1606899385526-1606899403667,1606899406848-1606899641952,1606899644477-1606899747431,1606899750032-1606900323476,1606900326580-1606900599687,1606900602069-1606900854979,1606900859182-1606900944590,1606900948061-1606901156728,1606901171184-1606901213473,1606901261720-', '2020-12-02 17:27:42', NULL, '2020-12-02 16:56:26', NULL, '2020-12-02 17:27:44', NULL, 0);
...
CREATE TABLE `k_trans_record`  (
  ...
  `record_trans_id` int(11) DEFAULT NULL COMMENT '转换ID',
  `start_time` datetime(0) DEFAULT NULL COMMENT '启动时间',
  `stop_time` datetime(0) DEFAULT NULL COMMENT '停止时间',
  `record_status` int(11) DEFAULT NULL COMMENT '任务执行结果（1：成功；0：失败）',
  `log_file_path` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '转换日志记录文件保存位置',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
  ...
  `category_id` int(11) DEFAULT NULL COMMENT '分类ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '转换执行记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of k_trans_record
-- ----------------------------
INSERT INTO `k_trans_record` VALUES (1, 2, '2020-12-02 16:49:55', '2020-12-02 16:49:56', 0, '/apps/logs/kettle-scheduler/run-logs/trans/2/1606898995942.txt', '2020-12-02 16:49:56', NULL, '2020-12-02 16:49:56', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (2, 2, '2020-12-02 16:54:23', '2020-12-02 16:54:24', 0, '/apps/logs/kettle-scheduler/run-logs/trans/2/1606899263583.txt', '2020-12-02 16:54:24', NULL, '2020-12-02 16:54:24', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (3, 3, '2020-12-02 16:56:26', '2020-12-02 16:56:26', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606899385888.txt', '2020-12-02 16:56:26', NULL, '2020-12-02 16:56:26', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (4, 3, '2020-12-02 16:56:47', '2020-12-02 16:56:47', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606899407168.txt', '2020-12-02 16:56:47', NULL, '2020-12-02 16:56:47', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (5, 3, '2020-12-02 17:00:44', '2020-12-02 17:00:45', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606899644804.txt', '2020-12-02 17:00:45', NULL, '2020-12-02 17:00:45', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (6, 3, '2020-12-02 17:02:30', '2020-12-02 17:02:30', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606899750357.txt', '2020-12-02 17:02:30', NULL, '2020-12-02 17:02:30', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (7, 3, '2020-12-02 17:12:07', '2020-12-02 17:12:08', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606900327520.txt', '2020-12-02 17:12:08', NULL, '2020-12-02 17:12:08', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (8, 3, '2020-12-02 17:22:28', '2020-12-02 17:22:29', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606900949013.txt', '2020-12-02 17:22:29', NULL, '2020-12-02 17:22:29', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (9, 3, '2020-12-02 17:26:11', '2020-12-02 17:26:16', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606901175515.txt', '2020-12-02 17:26:16', NULL, '2020-12-02 17:26:16', NULL, 0, 2);
INSERT INTO `k_trans_record` VALUES (10, 3, '2020-12-02 17:27:42', '2020-12-02 17:27:44', 1, '/apps/logs/kettle-scheduler/run-logs/trans/3/1606901264012.txt', '2020-12-02 17:27:44', NULL, '2020-12-02 17:27:44', NULL, 0, 2);
...
CREATE TABLE `k_user`  (
  ...
  `email` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户邮箱',
  `phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用于电话',
  `account` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户账号',
  `password` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户密码',
  `add_time` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `add_user` int(11) DEFAULT NULL COMMENT '添加者',
  `edit_time` datetime(0) DEFAULT NULL COMMENT '编辑时间',
  `edit_user` int(11) DEFAULT NULL COMMENT '编辑者',
...
-- Records of k_user
-- ----------------------------
INSERT INTO `k_user` VALUES (1, '管理员', NULL, NULL, 'admin', '00c952ef1f15bf47c1af8d35a0ccaa4620d12e018734ef63a37cf379050b117c', '2019-11-20 20:11:53', 1, '2019-12-06 11:13:38', 1, 1);
...
CREATE TABLE `r_cluster`  (
  ...
  `BASE_PORT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SOCKETS_BUFFER_SIZE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SOCKETS_FLUSH_INTERVAL` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_condition`  (
  ...
  `LEFT_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONDITION_FUNCTION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RIGHT_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_database`  (
  ...
  `DATABASE_NAME` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `PORT` int(11) DEFAULT NULL,
  `USERNAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PASSWORD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SERVERNAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DATA_TBS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `INDEX_TBS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_database_attribute`  (
  ...
  `VALUE_STR` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `r_directory`  (
  ...
  `DIRECTORY_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_element_attribute`  (
  ...
  `ATTR_KEY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ATTR_VALUE` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `r_job`  (
  ...
  `NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DESCRIPTION` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `EXTENDED_DESCRIPTION` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `JOB_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `JOB_STATUS` int(11) DEFAULT NULL,
  `ID_DATABASE_LOG` int(11) DEFAULT NULL,
  `TABLE_NAME_LOG` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `MODIFIED_USER` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `SHARED_FILE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_job_lock`  (
  ...
  `LOCK_MESSAGE` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `LOCK_DATE` datetime(0) DEFAULT NULL,
...
CREATE TABLE `r_log`  (
  ...
  `LOGTYPE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FILENAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FILEEXTENTION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_note`  (
  ...
  `FONT_NAME` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `r_partition`  (
  ...
  `PARTITION_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_partition_schema`  (
  ...
  `PARTITIONS_PER_SLAVE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_repository_log`  (
  ...
  `REP_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `LOG_DATE` datetime(0) DEFAULT NULL,
  `LOG_USER` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `OPERATION_DESC` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `r_slave`  (
  ...
  `WEB_APP_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `USERNAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PASSWORD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PROXY_HOST_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PROXY_PORT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NON_PROXY_HOSTS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_step`  (
  ...
  `GUI_LOCATION_Y` int(11) DEFAULT NULL,
  `GUI_DRAW` tinyint(1) DEFAULT NULL,
  `COPIES_STRING` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_step_type`  (
  ...
  `CODE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DESCRIPTION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `HELPTEXT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_transformation`  (
  ...
  `DESCRIPTION` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `EXTENDED_DESCRIPTION` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `TRANS_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `TABLE_NAME_MAXDATE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FIELD_NAME_MAXDATE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_value`  (
  ...
  `VALUE_STR` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `r_version`  (
  ...
  `UPGRADE_DATE` datetime(0) DEFAULT NULL,
